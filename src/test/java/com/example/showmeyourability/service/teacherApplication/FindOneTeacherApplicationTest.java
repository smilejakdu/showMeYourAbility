...
public class FindOneTeacherApplicationTest {
    @Mock
    ...
    @InjectMocks
    private FindOneTeacherByIdApplication findOneTeacherByIdApplication;
    ...
    void doesNotExistFindOneTeacherByIdTestWhenTeacher() {
        ...
        HttpExceptionCustom exception = assertThrows(HttpExceptionCustom.class, () -> {
            findOneTeacherByIdApplication.execute(teacherId);
        });
